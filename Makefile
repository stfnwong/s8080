...
# ======== TEST ======== #
TESTS=test_cpu test_lexer test_token test_opcode test_line_info test_source_info test_assembler test_symbol_table test_instr_buffer test_list test_vector test_instr_vector
